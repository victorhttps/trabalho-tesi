            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="/index.php/login/validalogin" method="POST">
                    ...
                    <div class="col-12"> <button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Entrar</button> </div>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="login/registro">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
